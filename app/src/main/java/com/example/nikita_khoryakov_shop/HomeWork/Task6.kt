...
class Presenter() {
    private val iphoneCase = Product1(price = 123.5, salePercent = 30, productName = "IphoneCase")
    private val samsungCase = Product1(price = 124.5, salePercent = 15, productName = "SamsungCase")
    private val pricePrinter: PricePrinter1 = ConsolePricePrinter()
...
class ConsolePricePrinter : PricePrinter1 {
